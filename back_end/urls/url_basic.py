...
urlpatterns = [
    ...
    url(r'^blog/', include('back_end.urls.url_test')),
    url(r'^about/', include('back_end.urls.url_about')),
    ...
    # url(r'^test/data', 'back_end.view_test.data', name='data'),
    # url(r'^test/store_info_all', 'back_end.view_test.store_info_all', name='store_info_all'),
    # url(r'^test/files', 'back_end.view_test.files', name='files'),
    # url(r'^test/editor', 'back_end.view_test.editor', name='editor'),
    # url(r'^test/showup', 'back_end.view_test.showup', name='showup'),

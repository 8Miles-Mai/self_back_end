...
urlpatterns = [
    ...
    url(r'^$', 'back_end.views.index', name='index'),
    ...
    url(r'^data', 'back_end.views.data', name='data'),
    url(r'^store_info_all', 'back_end.views.store_info_all', name='store_info_all'),
    url(r'^files', 'back_end.views.files', name='files'),
    url(r'^editor', 'back_end.views.editor', name='editor'),
    url(r'^showup', 'back_end.views.showup', name='showup'),
